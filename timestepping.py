...
def step_rk2_RE(x, dt, b, r, sigma, linearise=False):
    ...
    k_1 = 0.5 * dt * calc_dxdt(x_intermediate_step, b, r, sigma, linearise)
    k_2 = 0.5 * dt * calc_dxdt(x_intermediate_step + 0.5 * k_1, b, r, sigma, linearise)
...
def step_rk4_RE(x, dt, b, r, sigma, linearise=False):
    ...
    k_1 = 0.5 * dt * calc_dxdt(x_intermediate_step, b, r, sigma, linearise)
    k_2 = 0.5 * dt * calc_dxdt(x_intermediate_step + 0.5 * k_1, b, r, sigma, linearise)
    k_3 = 0.5 * dt * calc_dxdt(x_intermediate_step + 0.5 * k_2, b, r, sigma, linearise)
    k_4 = 0.5 * dt * calc_dxdt(x_intermediate_step + k_3, b, r, sigma, linearise)
